...
function theme_enqueue_styles() {
    ...
    wp_enqueue_style('opensanscondensed', '//fonts.googleapis.com/css2?family=Open+Sans+Condensed:wght@300&display=swap');
    wp_enqueue_style('opensans', '//fonts.googleapis.com/css2?family=Open+Sans:wght@300;700&display=swap');
